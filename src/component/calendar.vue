...
<template>
    <div>
        <span class="txtDatePicker" v-if="$calendar.locale == 'fa'" @click="visible = !visible"> {{selectedDay.format('jYYYY-jMM-jDD')}} </span>
        <span class="txtDatePicker" v-else @click="visible = !visible">{{selectedDay.format('YYYY-MM-DD')}}</span>
